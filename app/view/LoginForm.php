...
<!-- Mirrored from kodesolution.com/demo/wxyz/y/ngopress/v2.0/demo/form-job-apply-style1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Jan 2017 17:44:40 GMT -->
<head>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-center">
              <h2 class="title text-white"> Login in your area </h2><br><br>
        ...
        <div class="row">
          <div class="col-md-6 col-md-push-3">
            <div class="border-1px p-30 mb-0">
              <h3 class="text-theme-colored mt-0 pt-5">LOGIN </h3>
              <hr>
              
              <form method="POST" action="../../public/objects/login.php">
               <div class="row">
				<div class="col-sm-6">
                    <div class="form-group">
				 <label for="username">Username</label>
                <input type="text" id="username" name="email" placeholder="Email Id">
					</div></div>
					</div>
					<div class="row">
				<div class="col-sm-6">
             ...
             <!-- <script type="text/javascript">
                $("#job_apply_form").validate({
                  submitHandler: function(form) {
                    var form_btn = $(form)"../../../public/html/login.php".find('button[type="submit"]');
