        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <ul class="menuzord-menu" >
              <li>
                <a class="btn btn-colored btn-flat btn-theme-colored mt-15 ajaxload-popup" href=".html" >Profile </a>
              </li>
              <li>
              ...
              <li>
			   ...
			   <li>
                <a class="btn btn-colored btn-flat btn-theme-colored mt-15 ajaxload-popup" href="Demo.html" >Logout</a>
              </li>
              <li>
